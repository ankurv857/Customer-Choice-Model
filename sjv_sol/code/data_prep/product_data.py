...
if __name__ == '__main__':
    ...
    for _, row in df.iterrows():
        ...
        for product_id in product_set:
            ...
            # print(user_ids, 'product_ids', product_ids, 'labels', labels) ; exit()
            ...
            # print(aisle_ids, 'aisle_ids', department_ids, 'department_ids', product_names) ; exit()
        ...
        # print(is_ordered_histories, 'is_ordered_histories', index_in_order_histories, 'index_in_order_histories') ; exit()
