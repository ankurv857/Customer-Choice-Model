...
if __name__ == '__main__':
    ...
    np.save('../../../data/model_data/user_id.npy', user_id)
    np.save('../../../data/model_data/product_id.npy', product_id)
    np.save('../../../data/model_data/aisle_id.npy', aisle_id)
    np.save('../../../data/model_data/department_id.npy', department_id)
    # np.save('../../data/model_data/eval_set.npy', eval_set)
    np.save('../../../data/model_data/label.npy', label)

    np.save('../../../data/model_data/is_ordered_history.npy', is_ordered_history)
    np.save('../../../data/model_data/index_in_order_history.npy', index_in_order_history)
    ...
    np.save('../../../data/model_data/order_size_history.npy', order_size_history)
    np.save('../../../data/model_data/reorder_size_history.npy', reorder_size_history)
    np.save('../../../data/model_data/order_number_history.npy', order_number_history)
    np.save('../../../data/model_data/product_name.npy', product_name)
    np.save('../../../data/model_data/product_name_length.npy', product_name_length)
    np.save('../../../data/model_data/history_length.npy', history_length)